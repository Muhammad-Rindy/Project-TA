                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <form action="{{ route('update-data', $product) }}" method="post"
                                                    enctype="multipart/form-data">
                                                    @method('patch')
                                                    @csrf
                                                    <div style="text-align: left">
                                                        <label for="site" class="form-label">Model</label>
                                                    </div>
                                                    <input name="model" class="form-control mt-1 mb-3" type="text"
                                                        aria-label="default input example" value="{{ $product->model }}">
                                                    <div style="text-align: left">
                                                        <label for="site" class="form-label">Merk</label>
                                                    </div>
                                                    <input class="form-control mt-1 mb-3" type="text" name="merk"
                                                        aria-label="default input example" value="{{ $product->merk }}">
                                                    <div style="text-align: left">
                                                        <label for="plat" class="form-label">Number
                                                            Police</label>
                                                    </div>
                                                    <input class="form-control mt-1 mb-3" type="text" name="plat"
                                                        aria-label="default input example" value="{{ $product->plat }}">
                                                    <div style="text-align: left">
                                                        <label for="site" class="form-label">Type</label>
                                                    </div>
                                                    <input class="form-control mt-1 mb-3" type="text" name="type"
                                                        aria-label="default input example" value="{{ $product->type }}">

                                                    <div style="text-align: left">
                                                        <label for="name" class="form-label">Speed</label>
                                                    </div>
                                                    <input class="form-control mt-1 mb-3" type="text" name="speed"
                                                        aria-label="default input example" value="{{ $product->speed }}">
                                                    <div style="text-align: left">
                                                        <label for="site" class="form-label">Transmition</label>
                                                    </div>
                                                    <select class="form-select mt-1 mb-1"
                                                        aria-label="Default select example" name="transmition">
                                                        <option selected>
                                                    ...
                                                    <input class="form-control mt-1 mb-3" type="text" name="color"
                                                        aria-label="default input example" value="{{ $product->color }}">
                                                    <div style="text-align: left">
                                                        <label for="name" class="form-label">Fuel</label>
                                                    </div>
                                                    <input class="form-control mt-1 mb-3" type="text" name="fuel"
                                                        aria-label="default input example" value="{{ $product->fuel }}">
                                                    <div style="text-align: left">
                                                        <label for="name" class="form-label">Years</label>
                                                    </div>
                                                    <input class="form-control mt-1 mb-3" type="number"
                                                        name="years_output" aria-label="default input example"
                                                        value="{{ $product->years_output }}">
                                                    <div style="text-align: left">
                                                        <label for="site" class="form-label">Description</label>
                                                    </div>
                                                    ...
                                                    <input class="form-control mt-1 mb-3" type="number" name="price"
                                                        aria-label="default input example" value="{{ $product->price }}">
                                                    <div style="text-align: left">
