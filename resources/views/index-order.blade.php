                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    <form action="" method="post"
                                                                        ...
                                                                        <input name="name" class="form-control mt-1 mb-3"
                                                                            type="text"
                                                                        ...
                                                                        <input class="form-control mt-1 mb-3" type="text"
                                                                            name="number_phone"
                                                                            aria-label="default input example"
                                                                            value="{{ $message->number_phone }}" readonly>
                                                                        <div style="text-align: left">
                                                                            <label for="site"
                                                                        ...
                                                                        <div style="text-align: left">
                                                                            <label for="site"
                                                                                class="form-label">Number Police</label>
                                                                        </div>
                                                                        <input class="form-control mt-1 mb-3"
                                                                            type="text" name="plat_rent"
                                                                            aria-label="default input example"
                                                                            value="{{ $message->plat_rent }}" readonly>
                                                                        <div style="text-align: left">
                                                                            <label for="site" class="form-label">Long
                                                                                Rent Day</label>
                                                                        </div>
                                                                        <input class="form-control mt-1 mb-3"
